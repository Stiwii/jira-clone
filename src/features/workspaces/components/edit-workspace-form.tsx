...
export const EditWorkspaceForm = ({
  ...
  const [ResetDialog, confirmReset] = useConfirm(
    "Reset inte link",
    "This wil invalidate the current invite link. Are you sure you want to reset it?",
    "destructive"
  );
  ...
  return (
    <div className="flex flex-col gap-y-4">
                    ...
                    <div className="felx flex-col gap-y-2">
                      <div className="flex items-center gap-x-5">
                        ...
                        <div className="flex flex-col">
                          <p className="text-sm">Workspaces Icon</p>
      ...
      <Card className="w-full h-full boder-none shadow-none">
        <CardContent className="p-7">
          <div className="flex flex-col">
      ...
      <Card className="w-full h-full boder-none shadow-none">
        <CardContent className="p-7">
          <div className="flex flex-col">
            ...
            <p className="text-sm text-muted-foreground">
              Deleting a workspace is permanent and will remove all associated
              data.
            </p>
            <DottedSeparator className="py-7" />
            <Button
